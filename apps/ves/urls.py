...
urlpatterns = [
    ...
    path('data',  StartView.menu_data, name = 'menu_data'),
    path('data/contragents',  StartView.menu_data, name = 'contragents'),
    path('data/actions',  StartView.menu_data, name = 'actions'),
